...
public class FenFXML_InscriptionControleur implements Initializable
{
    ...
    {
        // Conservation de l'item selectionné dans le TableView dans HelloApplication
        HelloApplication.setMaSessionSelectionnee(tableSessionsAutorisees.getSelectionModel().getSelectedItem());
        // Conservation de l'item selectionné dans le ComboBox dans HelloApplication
        HelloApplication.setMonClientSelectionne(((Client)cmb_ChoixMatricule.getSelectionModel().getSelectedItem()));
        ...
        try
        {
            ...
            FXMLLoader loader = new FXMLLoader(HelloApplication.class.getResource("/vue/FenFXML_ConfirmationInscription.fxml"));
